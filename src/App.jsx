...
const TRUSTED_ORGS = [
  { n: "As-Sunnah Foundation", desc: "Zakat Fund (via bKash)", bn: "আস-সুন্নাহ ফাউন্ডেশন", link: "https://donation.bkash.com/en/assf/donate" },
...
export default function App() {
  ...
  const VCalc = () => {
    ...
    <div style={{ marginBottom: 12 }}><label style={{ fontSize: 11, fontWeight: 700, color: "var(--t2)", marginBottom: 5, display: "block" }}>{bn ? "⏳ হাওল শুরুর তারিখ (ঐচ্ছিক)" : "⏳ Hawl Start Date (Optional)"}</label><div style={{ fontSize: 10, color: "var(--t3)", marginBottom: 6, lineHeight: 1.5, background: "var(--inp)", padding: "6px 10px", borderRadius: 8 }}>{bn ? "হাওল = চন্দ্র বছর (৩৫৪ দিন)। সম্পদ নিসাব ছাড়ানোর তারিখ দিন — এক হাওল পূর্ণ হলে যাকাত ফরজ।" : "Hawl = Islamic lunar year (354 days). Enter when your wealth first exceeded Nisab. Zakat is due when one Hawl completes."}</div><input type="date" value={hawlDate} onChange={e => setHawlDate(e.target.value)} style={{ width: "100%", padding: "11px 13px", border: "1.5px solid var(--bd)", borderRadius: 9, fontSize: 13, background: "var(--inp)", color: "var(--t1)", outline: "none", fontFamily: "inherit", boxSizing: "border-box" }} /></div>
